# 微服务认证与授权
这里我们使用 oauth2 和 Spring Security 来做spring cloud 微服务的认证与授权
...
#### 3.2.2 配置微服务名称
参考 [application.yml](src/main/resources/application.yml)
```yaml
spring:
  application:
    name: oauth2-server
...
#### 3.2.6 用户信息查询业务类实现
* 1.对应的bo类  
    [User.java](../msc-common/src/main/java/com/chennan/cloud/bo/User.java)  
    [Role.java](../msc-common/src/main/java/com/chennan/cloud/bo/Role.java)  
    [Permission.java](../msc-common/src/main/java/com/chennan/cloud/bo/Permission.java)  
* 2.Mapper接口
```java
...
##### 3.3.3.2 获取令牌
```shell script
curl -POST http://localhost:11000/auth/oauth/token?grant_type=password&username=zhang.san&password=123456 
```
响应结果
```json
{
	"additionalInformation": {},
	"expiration": "2019-10-07 07:02:01",
	"expired": false,
	"expiresIn": 41658,
	"refreshToken": {
		"expiration": "2019-10-13 19:02:01",
		"value": "40c4e67d-8ed4-4d3e-b197-160e681ef77c"
	},
	"scope": [
		"read"
	],
	"tokenType": "bearer",
	"value": "901df61f-db17-4351-98b9-2b9771cb2256"
}
```

##### 3.3.3.3 带token访问接口
```shell script
curl -XGET http://localhost:11000/user/api/current?access_token=901df61f-db17-4351-98b9-2b9771cb2256
```
响应结果：
```json
{
